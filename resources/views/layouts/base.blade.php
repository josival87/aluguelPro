...
@elseif($area === 'client')
    <header class="client-top"><a class="brand" href="{{ route('client.dashboard') }}"><span class="brand-mark">A</span>Aluga<strong>Pro</strong></a><div class="client-greeting"><small>Olá,</small> {{ auth()->user()->name }}</div></header>
@else
