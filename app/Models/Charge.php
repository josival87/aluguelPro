...
{
    protected $fillable = [
        'lease_id', 'client_id', 'type', 'reference_month', 'due_date', 'amount',
    ...
    public function pixPayments() { return $this->hasMany(PixPayment::class); }
    public function solarReading() { return $this->hasOne(SolarReading::class); }
    public function notificationLogs() { return $this->hasMany(NotificationLog::class); }

    public function getDisplayStatusAttribute(): string
    {
        if ($this->status === 'paid') return 'Pago';
